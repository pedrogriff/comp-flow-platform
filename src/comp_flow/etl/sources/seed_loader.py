            ...
            for geo, factor in cls.GEO_MULTIPLIERS.items():
                benchmarks.append(
                    MarketBenchmark(
                        ...
                        p50_equity_rsus=int(data["p50_equity"]),
                        p75_equity_rsus=int(data["p75_equity"]),
